 ...
 * Shared utilities are in ./shared.ts — tool modules import from there.
 *
 * Usage:
...
// Re-export shared utilities so tool modules extracted later can import from shared.ts
// (mcp-server.ts still uses its own local copies for now — migration is incremental)
...
// ── Vault Tools (extracted to vault-tools.ts) ───────────────────────────
...
// ── Team Tools (extracted to team-tools.ts) ─────────────────────────────
registerTeamTools(server);

// (team agent constants moved to shared.ts)

// (team tool code removed — see team-tools.ts)
// 
// ── Graph Memory Tools ─────────────────────────────────────────────────
...
// ── Persistent Goals (extracted to goal-tools.ts) ───────────────────────
...
// ── Delegation (extracted to team-tools.ts) ────────────────────────────

// ── Session & Discovery (extracted to session-tools.ts) ─────────────────
